...
func main() {
	...
	flagSet.Var(&emailDomain, "email-domain", "authenticate emails with the specified domain (may be given multiple times). Use * to authenticate any email")
